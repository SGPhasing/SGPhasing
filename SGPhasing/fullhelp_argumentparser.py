    ...
    def get_argument_list() -> list:
        ...
        argument_list.append({
            ...
            'help': 'Input a HiFi full-length '
                    'transcriptome bam/cram/sam file.'})
        argument_list.append({
            'opts': ('-f', '--fastx'),
            'dest': 'fastx',
            'required': True,
            'type': str,
            'help': 'Input a fasta/fastq file paired to bam/cram/sam file.'})
        argument_list.append({
            'opts': ('-r', '--ref'),
            'dest': 'reference',
            'required': True,
...
class PhaseArgs(SGPhasingArgs):
    ...
    def get_argument_list() -> list:
        ...
        argument_list.append({
            ...
            'required': True,
            'type': str,
            'help': 'Input a bam/cram/sam file for phasing.'})
        argument_list.append({
            'opts': ('-f', '--fastx'),
            'dest': 'fastx',
            'required': True,
        ...
        argument_list.append({
            ...
            'required': True,
            'type': str,
            'help': 'Input index file generated by SGPhasing Index.'})
        argument_list.append({
            'opts': ('-t', '--threads'),
            'dest': 'threads',
            'required': False,
