...
def write_index(output_index: str,
    ...
    for link_id, region_id_main_dict in zip(
            link_id_list, region_id_main_dict_list):
...
def seq_to_array(sequence: str) -> np.ndarray:
    ...
    BASE_INT = {
        ...
        'B': 13, 'b': 13,
        'N': 14, 'n': 14}
    return np.array([BASE_INT[base] for base in sequence], dtype=np.int8)
